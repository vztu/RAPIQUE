...
def arg_parser():
  ...
  parser.add_argument('--dataset_name', type=str, default='ALL_COMBINED',
                      help='Evaluation dataset.') 
  parser.add_argument('--feature_file', type=str,
                      default='feat_files/ALL_COMBINED_RAPIQUE_feats.mat',
                      help='Pre-computed feature matrix.')
  parser.add_argument('--mos_file', type=str,
                      default='mos_files/ALL_COMBINED_metadata.csv',
                      help='Dataset MOS scores.')
  parser.add_argument('--out_file', type=str,
                      default='result/ALL_COMBINED_RAPIQUE_binary_SVR_corr.mat',
...
def formatted_print(snapshot, params, duration):
  ...
  print('F1_train: ', snapshot[2])
  print('======================================================')
  print('ACC_test: ', snapshot[3])
  print('BACC_test: ', snapshot[4])
  print('F1_test: ', snapshot[5])
  print('======================================================')
...
def evaluate_bvqa_one_split(i, X, y, log_short):
  ...
  if X_train.shape[1] <= 4000:
    ...
    grid = RandomizedSearchCV(LinearSVC(), param_grid, cv=3)
...
def main(args):
  ...
  if args.dataset_name == 'LIVE_VQC':
      ...
      # y[pos_inds] = 1
      # y[~pos_inds] = 0
  elif args.dataset_name == 'ALL_COMBINED':
      y = array[1:,1]
      y_mos = np.array(list(y), dtype=np.float)
...
'''
evaluate_biqa_features_binary_classification.py [-h] [--model_name MODEL_NAME] \
...
python evaluate_bvqa_features_binary_classification.py \
  ...
  --feature_file feat_files/KONVID_1K_RAPIQUE_feats.mat \
  --mos_file mos_files/KONVID_1K_metadata.csv \
  --out_file result/LIVE_IQC_ResNet50_SVC_corr.mat \
  --use_parallel
'''
